  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <button style="width: 100px; height: 38px" @click="requireCode">获取验证码</button>
      ...
      <div class="btn">
        <button @click="user1Register">完成注册</button>
      </div>
    </div>
    ...
    <div class="copyright">
      ...
      <div class="address">地址:厦门工学院</div>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    async requireCode() {
      try {
        //简单判断下phone是否存在
        const { phone } = this //发送获取验证码请求
        phone && (await this.getCode(this.phone))
        //直接填写进验证码框
